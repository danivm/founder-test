export default {
  requirements: [
    ...
    },
    {
      ...
      params: ['Health Care'],
      priority: 'MUST',
      selectedParam: 'Health Care'
    },
    {
      id: '7',
      criteria: 'Sub-industry is',
      params: ['Medical Devices'],
      priority: 'MUST',
      selectedParam: 'Health Care'
    },
    {
